...
public class MarkdownConverter : DependencyObject, IValueConverter
{
    ...
    public static readonly DependencyProperty MarkdownProperty =
        DependencyProperty.Register(nameof(Markdown), typeof(Markdown), typeof(MarkdownConverter), new PropertyMetadata(null));
